    ...
    <div class="modal-dialog modal-dialog-scrollable modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Icon</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
            <div class="modal-body">
                <div class="row select-icon-abir">
                    ...
                    <div class="col-md-1 col-sm-6">
                        <div class="preview-icon"><i
                                class="ti-shopping-cart-full"></i><code>ti-shopping-cart-full</code>
                        </div>
                    </div>
                    <div class="col-md-1 col-sm-6">
                    ...
                    <div class="col-md-1 col-sm-6">
                        <div class="preview-icon"><i
                                class="ti-arrow-circle-right"></i><code>ti-arrow-circle-right</code>
                        </div>
                    </div>
                    <div class="col-md-1 col-sm-6">
                    ...
                    <div class="col-md-1 col-sm-6">
                        <div class="preview-icon"><i
                                class="ti-angle-double-right"></i><code>ti-angle-double-right</code>
                        </div>
                    </div>
                    <div class="col-md-1 col-sm-6">
                    ...
                    <div class="col-md-1 col-sm-6">
                        <div class="preview-icon"><i
                                class="ti-themify-favicon-alt"></i><code>ti-themify-favicon-alt</code>
                        </div>
                    </div>
                    <div class="col-md-1 col-sm-6">
                    ...
                    <div class="col-md-1 col-sm-6">
                        <div class="preview-icon"><i
                                class="ti-layout-width-default"></i><code>ti-layout-width-default</code>
                        </div>
                    </div>
                    <div class="col-md-1 col-sm-6">
                        <div class="preview-icon"><i
                                class="ti-layout-width-default-alt"></i><code>ti-layout-width-default-alt</code>
                        </div>
                    </div>
                    <div class="col-md-1 col-sm-6">
                    ...
                    <div class="col-md-1 col-sm-6">
                        <div class="preview-icon"><i
                                class="ti-layout-sidebar-right"></i><code>ti-layout-sidebar-right</code>
                        </div>
                    </div>
                    <div class="col-md-1 col-sm-6">
                        <div class="preview-icon"><i
                                class="ti-layout-sidebar-none"></i><code>ti-layout-sidebar-none</code>
                        </div>
                    </div>
                    <div class="col-md-1 col-sm-6">
                        <div class="preview-icon"><i
                                class="ti-layout-sidebar-left"></i><code>ti-layout-sidebar-left</code>
                        </div>
                    </div>
                    <div class="col-md-1 col-sm-6">
                        <div class="preview-icon"><i
                                class="ti-layout-placeholder"></i><code>ti-layout-placeholder</code>
                        </div>
                    </div>
                    <div class="col-md-1 col-sm-6">
                    ...
                    <div class="col-md-1 col-sm-6">
                        <div class="preview-icon"><i
                                class="ti-layout-menu-separated"></i><code>ti-layout-menu-separated</code>
                        </div>
                    </div>
                    <div class="col-md-1 col-sm-6">
                    ...
                    <div class="col-md-1 col-sm-6">
                        <div class="preview-icon"><i
                                class="ti-layout-media-right-alt"></i><code>ti-layout-media-right-alt</code>
                        </div>
                    </div>
                    <div class="col-md-1 col-sm-6">
                        <div class="preview-icon"><i
                                class="ti-layout-media-right"></i><code>ti-layout-media-right</code>
                        </div>
                    </div>
                    <div class="col-md-1 col-sm-6">
                        <div class="preview-icon"><i
                                class="ti-layout-media-overlay"></i><code>ti-layout-media-overlay</code>
                        </div>
                    </div>
                    <div class="col-md-1 col-sm-6">
                        <div class="preview-icon"><i
                                class="ti-layout-media-overlay-alt"></i><code>ti-layout-media-overlay-alt</code>
                        </div>
                    </div>
                    <div class="col-md-1 col-sm-6">
                        <div class="preview-icon"><i
                                class="ti-layout-media-overlay-alt-2"></i><code>ti-layout-media-overlay-alt-2</code>
                        </div>
                    </div>
                    <div class="col-md-1 col-sm-6">
                        <div class="preview-icon"><i
                                class="ti-layout-media-left-alt"></i><code>ti-layout-media-left-alt</code>
                        </div>
                    </div>
                    <div class="col-md-1 col-sm-6">
                    ...
                    <div class="col-md-1 col-sm-6">
                        <div class="preview-icon"><i
                                class="ti-layout-media-center-alt"></i><code>ti-layout-media-center-alt</code>
                        </div>
                    </div>
                    <div class="col-md-1 col-sm-6">
                        <div class="preview-icon"><i
                                class="ti-layout-media-center"></i><code>ti-layout-media-center</code>
                        </div>
                    </div>
                    <div class="col-md-1 col-sm-6">
                    ...
                    <div class="col-md-1 col-sm-6">
                        <div class="preview-icon"><i
                                class="ti-layout-list-thumb-alt"></i><code>ti-layout-list-thumb-alt</code>
                        </div>
                    </div>
                    <div class="col-md-1 col-sm-6">
                    ...
                    <div class="col-md-1 col-sm-6">
                        <div class="preview-icon"><i
                                class="ti-layout-list-large-image"></i><code>ti-layout-list-large-image</code>
                        </div>
                    </div>
                    <div class="col-md-1 col-sm-6">
                    ...
                    <div class="col-md-1 col-sm-6">
                        <div class="preview-icon"><i
                                class="ti-layout-grid2-thumb"></i><code>ti-layout-grid2-thumb</code>
                        </div>
                    </div>
                    <div class="col-md-1 col-sm-6">
                    ...
                    <div class="col-md-1 col-sm-6">
                        <div class="preview-icon"><i
                                class="ti-layout-cta-btn-right"></i><code>ti-layout-cta-btn-right</code>
                        </div>
                    </div>
                    <div class="col-md-1 col-sm-6">
                        <div class="preview-icon"><i
                                class="ti-layout-cta-btn-left"></i><code>ti-layout-cta-btn-left</code>
                        </div>
                    </div>
                    <div class="col-md-1 col-sm-6">
                    ...
                    <div class="col-md-1 col-sm-6">
                        <div class="preview-icon"><i
                                class="ti-layout-accordion-separated"></i><code>ti-layout-accordion-separated</code>
                        </div>
                    </div>
                    <div class="col-md-1 col-sm-6">
                        <div class="preview-icon"><i
                                class="ti-layout-accordion-merged"></i><code>ti-layout-accordion-merged</code>
                        </div>
                    </div>
                    <div class="col-md-1 col-sm-6">
                        <div class="preview-icon"><i
                                class="ti-layout-accordion-list"></i><code>ti-layout-accordion-list</code>
                        </div>
                    </div>
                    <div class="col-md-1 col-sm-6">
                    ...
                    <div class="col-md-1 col-sm-6">
                        <div class="preview-icon"><i
                                class="ti-control-skip-forward"></i><code>ti-control-skip-forward</code>
                        </div>
                    </div>
                    <div class="col-md-1 col-sm-6">
                        <div class="preview-icon"><i
                                class="ti-control-skip-backward"></i><code>ti-control-skip-backward</code>
                        </div>
                    </div>
                    <div class="col-md-1 col-sm-6">
                    ...
                    <div class="col-md-1 col-sm-6">
                        <div class="preview-icon"><i
                                class="ti-layout-column4-alt"></i><code>ti-layout-column4-alt</code>
                        </div>
                    </div>
                    <div class="col-md-1 col-sm-6">
                        <div class="preview-icon"><i
                                class="ti-layout-column3-alt"></i><code>ti-layout-column3-alt</code>
                        </div>
                    </div>
                    <div class="col-md-1 col-sm-6">
                        <div class="preview-icon"><i
                                class="ti-layout-column2-alt"></i><code>ti-layout-column2-alt</code>
                        </div>
                    </div>
                    <div class="col-md-1 col-sm-6">
