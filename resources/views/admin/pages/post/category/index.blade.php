                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="text-danger" href="{{ route('post.category.status.update',$item->id) }}"><i
                                    ...
                                    @if (Auth::guard('admin')->user()->role->name == 'Admin')
                                    <a class="text-success" href="{{ route('post.category.status.update',$item->id) }}"><i
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-sm btn-warning" href="{{ route('post-category.edit', $item->id) }}"><i
                                            class="fa fa-edit" aria-hidden="true"></i></a>
                                    @if ($form_type=='create')
                                    <form class="d-inline delete-form"
                                        action="{{ route('post-category.destroy', $item->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('post-category.update',$edit->id) }}" method="POST">
                    ...
                    <div class="text-right">
                        <a class="btn btn-info" href="{{ route('post-category.index') }}">Back</a>
